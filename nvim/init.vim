...
Plug 'tacahiroy/ctrlp-funky'     " Extended ctrlp
...
" notes
Plug 'xolox/vim-misc'                     " Note requirment
...
" YCM/YouCompleteMe
let g:ycm_global_ycm_extra_conf = " ~/.config/nvim/plug/YouCompleteMe/.ycm_extra_conf.py"
let g:ycm_extra_conf_globlist = ['~/prj/*']
let g:ycm_goto_buffer_command = 'horizontal-split'
nmap <leader>g :YcmCompleter GoTo<CR>
nmap <leader>d :YcmCompleter GoToDefinition<CR>
au FileType python nmap gd :YcmCompleter GoToDefinition<CR>
au FileType python nmap gs :YcmCompleter GoTo<CR>
au FileType python nmap gf :CtrlSF<CR>
au FileType python nmap gh :GrepperRg <cword><CR>
...
let g:vimtex_latexmk_progname = '/home/antdup/.config/nvim/plug/neovim-remote/nvr'
...
" 80 character
let &colorcolumn="79,".join(range(88,88),",")
...
let g:black_virtualenv = "~/virt_env/black_env/"
...
" Go
let g:go_version_warning = 0  "Remove warning
